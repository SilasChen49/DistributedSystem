 ...
 implements ServiceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("bookRoom", new Integer (1));
    _methods.put ("getAvailableTimeSlot", new Integer (2));
    _methods.put ("cancelBooking", new Integer (3));
    _methods.put ("createRoom", new Integer (4));
    _methods.put ("deleteRoom", new Integer (5));
    _methods.put ("changeReservation", new Integer (6));
  }
